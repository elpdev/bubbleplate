...
import (
	...
	"[[ .ModulePath ]]/internal/components/footer"
	"[[ .ModulePath ]]/internal/components/header"
	"[[ .ModulePath ]]/internal/components/modal"
	"[[ .ModulePath ]]/internal/components/sidebar"
...
func (m Model) View() tea.View {
	...
	head := header.View(header.Model{AppName: "[[ .DisplayName ]]", ScreenTitle: active.Title(), Version: m.meta.Version}, dims.Header.Width, dims.Header.Height, m.theme)
